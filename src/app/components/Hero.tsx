  ...
  return (
    <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: "url('/hero-bg.png')" }}>
      ...
      <div className="absolute inset-0 bg-opacity-50 flex items-center justify-center">
        <div className="bg-white ml-96 bg-opacity-90 p-8 rounded-lg max-w-md text-center shadow-lg">
          ...
          <button className="mt-6 bg-yellow-100 text-white font-medium py-2 px-4 rounded hover:bg-yellow-500 transition">
            Buy Now
          </button>
        </div>
      </div>
